...
class MockSummarizeRequest(BaseModel):
    ...
    note_type: Optional[str] = Field(default="progress_note", description="Type of clinical note")
    ai_model: Optional[str] = Field(default="gpt-4-turbo", description="AI model to use")
