...
class TestEvidenceScoring:
    ...
    def test_score_note_with_strong_evidence(self):
        ...
        result = score_note_defensibility(note_text=note_text, diagnosis_codes=["E43"])

        assert (
            result["overall_score"] >= 80
        ), "Note with strong evidence should score high"
    ...
    def test_score_note_with_missing_evidence(self):
        ...
        ), "Note with missing evidence should score low"
    ...
    def test_score_note_with_sepsis_evidence(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["A41.9"]
        )
    ...
    def test_score_note_with_chf_evidence(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["I50.9"]
        )
    ...
    def test_score_note_with_aki_evidence(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["N17.9"]
        )
    ...
    def test_score_note_with_respiratory_failure_evidence(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["J96.00"]
        )
    ...
    def test_score_note_with_multiple_diagnoses(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["E43", "N17.9"]
        )
    ...
    def test_score_note_with_unknown_diagnosis(self):
        ...
        result = score_note_defensibility(
            note_text=note_text, diagnosis_codes=["Z99.99"]  # Unknown code
        )
    ...
    def test_score_empty_note(self):
        ...
        result = score_note_defensibility(note_text="", diagnosis_codes=[])
...
class TestRevenueModel:
    ...
    def test_estimate_revenue_risk_basic(self):
        ...
        scored_notes = [
            {
                "overall_score": 50,
                "diagnoses": [{"code": "E43", "evidence_present": False}],
            },
            {
                "overall_score": 90,
                "diagnoses": [{"code": "E43", "evidence_present": True}],
            },
            {
                "overall_score": 60,
                "diagnoses": [{"code": "A41.9", "evidence_present": False}],
            },
        ]
    ...
    def test_calculate_annual_projection(self):
        ...
        result = calculate_annual_projection(
            current_risk=10000, notes_in_sample=100, annual_note_volume=10000
        )
    ...
    def test_calculate_annual_projection_zero_sample(self):
        ...
        result = calculate_annual_projection(
            current_risk=0, notes_in_sample=0, annual_note_volume=10000
        )
...
class TestShadowModeAPI:
        ...
        response = client.post(
            ...
            json={
                "notes": [
                    ...
                    {"note_text": "Patient has condition", "diagnosis_codes": ["E43"]},
                ]
            },
        )
    ...
    def test_analyze_endpoint_empty_notes(self):
        ...
        response = client.post(
            "/v1/shadow/analyze", headers=headers, json={"notes": []}
        )
    ...
    def test_analyze_endpoint_tenant_isolation(self):
        ...
        response = client.post(
            "/v1/shadow/analyze",
            headers=headers,
            json={"notes": [{"note_text": "Test note", "diagnosis_codes": ["E43"]}]},
        )
    ...
    def test_dashboard_endpoint_with_annual_volume(self):
        ...
        client.post(
            ...
            json={
                "notes": [
                    {"note_text": "Poor documentation", "diagnosis_codes": ["E43"]}
                ],
                "average_claim_value": 20000,
        ...
        response = client.get(
            "/v1/shadow/dashboard?annual_note_volume=10000", headers=headers
        )
...
class TestShadowModeSecurity:
    ...
    def test_cross_tenant_isolation(self):
        ...
        client.post(
            ...
            headers=headers_a,
            json={
                "notes": [{"note_text": "Tenant A note", "diagnosis_codes": ["E43"]}]
            },
        )
    ...
    def test_role_based_access(self):
        ...
        note_payload = {
            "notes": [{"note_text": "Test note", "diagnosis_codes": ["E43"]}]
        }

        # Clinician should have access
        headers_clinician = create_jwt_headers("hospital-roles", role="clinician")
        response = client.post(
            "/v1/shadow/analyze", headers=headers_clinician, json=note_payload
        )
        assert response.status_code == 200
        ...
        response = client.post(
            "/v1/shadow/analyze", headers=headers_admin, json=note_payload
        )
        assert response.status_code == 200
