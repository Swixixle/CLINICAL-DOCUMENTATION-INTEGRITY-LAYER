...
def test_required_provenance_fields_canonicalization():
    ...
    required_fields = [
        ...
        "governance_policy_version", "human_attested_at_utc", "human_reviewed",
        "human_reviewer_id_hash", "issued_at_utc", "key_id", "model_name",
        "model_version", "note_hash", "nonce", "prompt_version",
